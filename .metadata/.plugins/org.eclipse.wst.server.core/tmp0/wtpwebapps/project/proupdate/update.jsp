...
<body>
	<div class="container">
		...
		<form class="well form-horizontal" action="Updatea" method="post"
			id="contact_form">
			<fieldset>
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="fa-solid fa-clipboard-list"></i></span> <input name="orderid"
								placeholder="訂單編號" class="form-control ud" type="text"
								value="${tickinfo.orderid}">
				...
				<div class="form-group">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="fa-solid fa-user"></i></span> <input name="userid"
								placeholder="會員" class="form-control ud" type="text"
								value="${tickinfo.userid }">
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="fa-solid fa-calendar-days"></i></span> <input type="text"
								id="datepicker" class="form-control" placeholder="日期"
								value="${tickinfo.startdate}">
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								class="form-control selectpicker" id="time">
				...
				<div class="form-group">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="fa-solid fa-house"></i></span> <select name="hallid"
								class="form-control selectpicker" id="halls">
				...
				<div class="form-group">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="fa-solid fa-chair"></i></span> <select name="Seatid"
								class="form-control selectpicker" id="seat">
				...
				<div class="form-group">
					...
					<div class="col-md-4 selectContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="fa-solid fa-ticket"></i></span> <select name="tickettypeid"
				...
				<div class="form-group">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="fa-solid fa-film"></i></span> <select name="movieid"
								class="form-control selectpicker" id="moviename">
				...
				<div class="form-group">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="fa-solid fa-coins"></i></span> <input name="onemoney"
								placeholder="單價" class="form-control" type="text" id="money">
						</div>
					</div>
				</div>
				<!-- Text input-->
				...
				<div class="form-group">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							...
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-home"></i></span> <select name="payout"
								class="form-control selectpicker">
								<option value=" ">是否付款</option>
								<option value="Y"
									<c:if test="${tickinfo.payout =='Y'}">
                        selected
                        </c:if>>已付</option>
								<option value="N"
									<c:if test="${tickinfo.payout =='N'}">
                        selected
                        </c:if>>未付</option>
							</select>
						</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<button class="btn btn-warning" id="seed">
							Senda <span class="glyphicon glyphicon-send"></span>
						</button>
					</div>
				</div>
            ...
            $.ajax({
                ...
                success: function (respones) {
					...
					$.each(respones,function(i,e){
						...
						let time = e.starttime.split('.')[0]
						$('#time').append(`<option value="\${e.showtimeid}" \${selectshow} >\${time}</option>`)
					})
